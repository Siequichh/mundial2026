    ...
    partidos: [
      {
        ...
        arbitro: { nombre: 'Slavko Vinčić', pais: 'Eslovenia', promAmarillas: 4.15 },
        extras: {
        ...
        resultadoReal: '1-0',
        nota: 'prórroga',
        postAnalisis: 'España campeona del mundo: 0-0 en los 90\' y 1-0 en la prórroga (Ferrán Torres, 106\', asistencia de cabeza de Nico Williams). La fija ACERTÓ por diseño: "España campeón" (59%, cuota 1.69) fue elegida precisamente porque cubría prórroga y penales, y el partido se decidió justo ahí — la alternativa "Gana España (90 min)" habría perdido, validando el criterio de usar el mercado a título en vez de a 90\' en una final tan pareja. Ni Messi ni Oyarzabal ni Yamal —los tres goleadores señalados— anotaron; decidió un suplente no listado (Ferrán Torres) tras una asistencia de otro suplente (Nico Williams), y Argentina quedó con diez por la doble amarilla de Enzo Fernández (93\') camino al alargue, un factor imposible de prever en la previa. Lección: en una final de máxima paridad estructural (43/30/27, sin favorito nítido), el modelo acertó en no sobrevalorar a España a 90\' y en blindar la fija con el seguro de prórroga; pero el guion real —gol tardío de un revulsivo con el rival en inferioridad— confirma que los goleadores "previstos" son la apuesta lógica, no la garantizada.',
        fijaAcerto: true,
      },
    ],
  },
    ...
    partidos: [
      {
        ...
        resultadoReal: '4-6',
        postAnalisis: 'Fija ACERTÓ: Over 1.5 (76%) — el partido terminó 4-6, 10 goles en total, récord histórico de goles en un partido por el tercer puesto. 🍀 Acierto con suerte parcial: la dirección era correcta (partido abierto, muchos goles) pero la magnitud fue absurda — el modelo esperaba xG ~2.75 total y cayeron 10 goles. La info de rotación inglesa fue incorrecta: Rice, Saka y Bellingham (listados como suplentes) fueron titulares y anotaron (Saka hat-trick, Rice y Bellingham un gol cada uno). Kane, señalado como goleador clave, NO marcó. Mbappé sí anotó doblete (10 goles en el torneo, récord histórico de 22 en Mundiales). Lección: en partidos por el tercer puesto, las "rotaciones previstas" a 24-48h del partido son poco fiables — los técnicos cambian de opinión, y la ausencia de presión defensiva amplifica los goles muy por encima de lo modelado.',
        fijaAcerto: true,
      },
    ],
  },
    ...
    partidos: [
      {
        ...
        contexto: 'La semifinal más cargada de historia del cuadro derecho. Inglaterra llega tras eliminar a R.D. Congo (2-1), México (3-2) y Noruega (2-1 en prórroga con un doblete heroico de Bellingham). Kane lleva 6 goles y Bellingham 6 — entre ambos concentran casi todo el peligro inglés. Argentina, campeona defensora, avanzó por la vía más dramática posible: 3-2 a Cabo Verde en prórroga, 3-2 a Egipto remontando un 0-2, y 3-1 a Suiza en prórroga (Mac Allister, Álvarez y Lautaro marcaron tras la expulsión de Embolo). Messi lleva 8 goles y lidera el Botín de Oro; su estado de forma es histórico para un Mundial a los 39 años. Ambos equipos jugaron prórroga en cuartos (solo 3 días de descanso para Argentina, 4 para Inglaterra), lo que nivela el desgaste físico. BAJA CONFIRMADA de Inglaterra: Jarell Quansah sigue suspendido (roja vs México, sanción de 2 partidos). Sin otras bajas importantes reportadas en ninguno de los dos equipos. El precedente más reciente: cuartos de Rusia 2018, donde Inglaterra ganó por penales tras el 1-1. Árbitro: Ismail Elfath (Estados Unidos). [RECAL 1h: XI confirmados según FlashScore — Inglaterra presenta sorpresas tácticas de Tuchel (4-2-3-1 / 3-4-2-1): Pickford; Spence, Guehi, Stones, James; Anderson, Rice; Gordon, Bellingham, Rogers; Kane (Bukayo Saka, Phil Foden, Mainoo y Walker no son titulares; entran Elliot Anderson y Morgan Rogers junto a Bellingham y Kane). En Argentina (4-4-2 / 4-3-3): E. Martínez; Molina, Romero, L. Martínez, Tagliafico; Giuliano Simeone, Paredes, Mac Allister, Enzo Fernández; Messi, Julián Álvarez — cambio notable respecto a lo previsto: Rodrigo De Paul fuera del XI titular, ingresando Giuliano Simeone por la banda derecha y Leandro Paredes en el mediocampo junto a Mac Allister y Enzo. Al reestructurarse tanto las bandas inglesas (sin Saka/Foden) como el motor derecho argentino (sin De Paul, con Simeone/Paredes), los ajustes en xG se compensan entre sí y el impacto neto en probabilidad 1X2 es <2%. Por tanto, xG (1.30/1.35), prob (36/29/35) y picks (Over 1.5 a 1.38, con Messi, Kane y Bellingham titulares como goleadores) se mantienen intactos. Árbitro confirmado: Ismail Elfath (Estados Unidos).]',
        ...
        arbitro: { nombre: 'Ismail Elfath', pais: 'Estados Unidos', promAmarillas: 3.7 },
        extras: {
    ...
    partidos: [
      {
        ...
        resultadoReal: '0-2',
        postAnalisis: 'Fija falló: Francia clasifica (58%) fue desmentida por una España que dominó el partido de principio a fin con un contundente 2-0. El modelo había advertido que España ya eliminó a Francia en la Euro 2024 limitando a Mbappé, y exactamente eso volvió a ocurrir — Mbappé fue neutralizado por la disciplina defensiva española y no pudo impactar el marcador. Los goles fueron de Oyarzabal (22\', penal tras falta de Digne a Yamal) y Porro (58\', combinación con Dani Olmo). Oyarzabal era nuestro pick de goleador #3 (30%) — acertó. El error fue de ponderación: las señales de que España podía repetir el guion de la Euro 2024 estaban en el propio contexto de la predicción, pero el modelo les dio menos peso que a la racha goleadora de Mbappé (8 goles). Lección: cuando un equipo ya demostró un plan táctico exitoso contra el mismo rival en un torneo reciente, esa variable merece más peso que la forma individual del rival — el plan colectivo neutraliza al individuo.',
        fijaAcerto: false,
      },
    ],
  },
    ...
    partidos: [
      {
        ...
        resultadoReal: '2-1',
        postAnalisis: 'Fija acertó: España clasifica se cumplió con un ajustado 2-1. El modelo tuvo razón en el favoritismo (56% a 90\', prob más alta de las tres fuentes) pero se equivocó en el guion: rompió la racha de 450 minutos sin recibir gol (De Ketelaere empató antes del descanso tras asistencia de De Bruyne, que sí apareció pese a la duda sobre su ritmo) y el partido fue más parejo de lo que sugería el 0 en contra acumulado. Falló el pick de goleador: ni Oyarzabal ni Yamal marcaron — el gol decisivo lo puso Mikel Merino (88\'), un jugador fuera del radar de riesgo. Lección: una valla invicta no es garantía de blindaje ante un rival con calidad de balón parado/contragolpe (De Bruyne-Trossard-De Ketelaere), y los killers "obvios" no siempre son los goleadores reales en partidos cerrados.',
        fijaAcerto: true,
      },
    ],
  },
